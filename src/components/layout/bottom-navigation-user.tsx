...
export default function BottomNavigationUser() {
  ...
  return (
    <div className='fixed bottom-0 left-0 z-50 w-full h-16 bg-white border-t border-gray-200 dark:bg-gray-700 dark:border-gray-600'>
      <div className='grid h-full grid-cols-3 font-medium mx-auto max-w-sm px-0 py-4 sm:max-w-md md:max-w-lg lg:max-w-md xl:max-w-lg'>
        {/* Home */}
        <Link
          href='/'
        ...
        <Link
          href='/donate'
          className={`inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group transition-colors ${
            isActive('/donate') ? 'bg-gray-50 dark:bg-gray-800' : ''
          }`}
        >
          <svg
            className={`w-5 h-5 mb-2 transition-colors ${
