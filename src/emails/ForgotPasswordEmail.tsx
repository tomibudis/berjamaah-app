        ...
        <Container style={styles.container}>
          ...
          <Section style={styles.card}>
            ...
            <Text style={styles.text}>
              Anda meminta untuk mereset password. Klik tombol di bawah ini
            ...
            <Text style={styles.helper}>
              Jika tombol tidak berfungsi, salin dan tempel tautan ini di
              peramban Anda:
            </Text>
            <Text style={styles.link}>{resetUrl}</Text>
            <Hr style={styles.hr} />
            <Text style={styles.finePrint}>
              Tautan ini akan kedaluwarsa dalam 1 jam untuk alasan keamanan.
